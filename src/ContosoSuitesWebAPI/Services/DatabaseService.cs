...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for single hotel.")]
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings for single hotel with begin date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")]int hotelId, [Description("The beginning date")]DateTime dt)
    {
